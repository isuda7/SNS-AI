...
# Remove whitespace to calculate true char length
...
for filepath in js_files:
    ...
    # Try to parse the JS as JSON inside the window.draftData.push(...)
    ...
    if match:
        try:
            ...
            for draft in drafts:
                ...
                if current_len < 1500:
                    # Append multiple times until it reaches 1500 chars (excluding spaces)
